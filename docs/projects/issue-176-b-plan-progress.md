...
| **PR 10**             | B 案最終 flip: `_headers` + `<meta>` 両側から `style-src 'unsafe-inline'` 削除 + `stripMetaStyleSrc` 撤去 + test 群 strict 化 + Astro island hash 取り込み (`sha256-vv9I...`) + `[068]` B 案完了記録 | ✅ merged | [#315 (merged 27d7f53)](https://github.com/fumtas1k/devtools/pull/315) (#176 / #305 close、follow-up: #316) |
